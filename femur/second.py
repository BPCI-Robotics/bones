...
class SelectionMenu:
    ...
    def __init__(self):
        ...
        controller.buttonDown.pressed(self._controller_button_down_pressed)
        controller.buttonRight.pressed(self._controller_button_right_pressed)
    ...
    def _controller_button_down_pressed(self):
        if self.disabled:
            return
    ...
    def _controller_button_right_pressed(self):
        if self.disabled:
            return
    ...
    def _controller_button_Y_pressed(self):
        if self.disabled:
            return
    ...
    def _controller_button_B_pressed(self):
        if self.disabled:
            return
...
def drunk_driver():
    ...
    while True:
        ...
        Thread(optical.object_detected(colour_detection))
